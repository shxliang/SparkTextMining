package com.shxliang.summary;


import com.shxliang.utils.BM25;
...
//                System.out.println(sentenceList.get(maxIndex)+":"+rankValueList.get(maxIndex));
    ...
    public static void main(String[] args) {
        String text = "美国商务部工业和安全局星期一（8月19日）认定，另外46家华为技术公司的子公司被列入实体清单中。这是对所有实体清单例行审查的一部分。5月以来，商务部已经将跟华为有关的100多个人或组织列入实体清单。对华为这些子公司的新限制从8月19日起开始生效。\n" +
                "美国商务部的新闻稿称，工业和安全局还宣布，根据出口管理条例，将延长临时通用许可证，授权在涉及出口、再出口和商品转移交易中，同受实体清单约束的华为及其非美国子公司具体，有限地接触。鉴于持续的国家安全和外交政策威胁，临时通用许可证继续的目的是为全美国的消费者提供必要的时间，从华为的设备过渡。该许可证将从2019年8月19日生效，再延长90天。\n" +
                "商务部长罗斯说：“在我们继续敦促消费者从华为产品过渡时，我们承认，为防止任何中断，需要更多的时间。同时，我们在商务部不断努力确保对华为及其子公司的任何出口都不违反实体清单或临时通用许可证的条款。”商务部的声明说，在临时通用许可证范围之外，受出口管理条例约束的任何出口，再出口，或国内商品转移，都将继续需要工业和安全局依据拒绝批准推定政策（a presumption of denial）审查后发放的许可证。\n" +
                "在美国商务部认定，华为从事与美国国家安全或外交政策利益的活动，包括据称违反“国际紧急经济权力法”，阴谋违反“国际紧急经济权力法”，向伊朗提供违禁金融服务，在调查那些据称违反美国制裁等其他非法活动中妨碍司法之后，华为被加入到实体清单中。\n" +
                "工业和安全局的使命是促进美国的国家安全和外交政策目标，确保有效地出口管制和条约遵守制度，推动持久的美国战略技术领导地位。工业和安全局致力于防止美国原产产品支持大规模杀伤性项目，恐怖主义，或破坏军事现代化计划的稳定。";

        String result = getSummary(text, 300, 0.85, 200, 0.0001);
