...
//        System.out.println(words);
    ...
    public static String getKeywords(String title, String content, int nKeywords, int windowSize, double d, int maxIter, double minDiff) {
        List<String> remove = new ArrayList<>();
        return getKeywords(title, content, nKeywords, windowSize, d, maxIter, minDiff, remove);
    }
